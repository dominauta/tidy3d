...
class Simulation(Box):  # pylint:disable=too-many-public-methods
    ...
    def plot(
        ...
        **patch_kwargs,
        ...
        hlim : Tuple[float, float] = None
            Horizontal bounds for plotting (x range if z specified, y range if x specified, etc)
        vlim : Tuple[float, float] = None
            Vertical bounds for plotting (y range if z specified, z range if x specified, etc)
    ...
    def plot_monitors(
        ...
        ax : matplotlib.axes._subplots.Axes = None
            Matplotlib axes to plot on, if not specified, one is created.
        lims : Tuple[Tuple[float, float], Tuple[float, float]] = None
            Horizontal and vertical limits of plot
    ...
    def _get_structures_2dbox(
        ...
        List[Tuple[:class:`.AbstractMedium`, shapely.geometry.base.BaseGeometry]]
            List of shapes and mediums on the plane.
        """
        (h_min, h_max), (v_min, v_max) = hlim, vlim
